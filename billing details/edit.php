...
$sql_query = "UPDATE expenses set id=$id,name='$name',date='$date',amount='$amount',note='$note',category='$category' where id=$id";
...
<body>
    <div class="container">
        <div class="jumbotron">
        <div ><h3 class='text-center'><b> Edit form</b></h3> </div>
